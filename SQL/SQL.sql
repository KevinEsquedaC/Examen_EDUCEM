...
--Obtener todos los miembros de la familia que tengan una comida asignada
SELECT * FROM catMiembro 
INNER JOIN catComidaMiembro 
ON catMiembro.miembroId = catComidaMiembro.miembroId;

/*
 Obtener todos los miembros de la familia con su respectiva comida asignada; incluir los miembros que no 
